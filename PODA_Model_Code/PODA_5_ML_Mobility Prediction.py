...
for case in case_all: 
    ...
    df3 = pd.DataFrame(prediction_origin, columns=['Retail and Recreation', 
    ...
    df3.to_excel('./Mobility projection/Mobility_Projection_'
                 +model_mark+'_YYG'+YYG_projection_Date
                 +'_MLmodel_'+ML_Model
                 +'_'+case+isopen+'.xlsx')
